...
class ScoreManu extends StatefulWidget {
  const ScoreManu({Key? key}) : super(key: key);

  @override
  State<ScoreManu> createState() => _ScoreManuState();
}

class _ScoreManuState extends State<ScoreManu> {
  var average = ((4/8)*100).toStringAsFixed(2);
  @override
                    ...
                    children: [
                      ...
                      Text(
                        'แมนยูvsอาเซน่อล\nเยือน : แพ้ 2-3\nเหย้า : ชนะ3-1 \n\nแมนยูvsแมนซิตี้\nเยือน : แพ้ 3-6\nเหย้า : ชนะ 2-1 \n\nแมนยูvsสเปอร์\nเยือน : แข่งวันที่28/4/2566 เวลา:02.15\nเหย้า : ชนะ2-0'
                            ...
                            '\n\nอัตราชนะที่เจอทีมBig6ด้วยกันเอง \nชนะ4นัดจากการลงเล่น8ครั้ง คิดเป็นอัตราการชนะ $average%',
