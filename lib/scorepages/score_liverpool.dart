...
class ScoreLiverpool extends StatefulWidget {
  const ScoreLiverpool({Key? key}) : super(key: key);

  @override
  State<ScoreLiverpool> createState() => _ScoreLiverpoolState();
}

class _ScoreLiverpoolState extends State<ScoreLiverpool> {
  var average = ((3/8)*100).toStringAsFixed(2);
  @override
